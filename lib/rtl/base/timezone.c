...

{
    ...
    if (!KSUCCESS(Status)) {
        printf("Time zone data failed validation.\n");
        goto DebugPrintTimeZoneDataEnd;
    }
...

{
    ...
    case TimeZoneOccasionLastWeekday:
        printf("Last%s ", RtlAbbreviatedWeekdayStrings[Weekday]);
        break;
