...
extern UINT8 _binary_cbfwv_start;
extern UINT8 _binary_cbfwv_end;
...

{
    ...
    Base = (EFI_PHYSICAL_ADDRESS)(UINTN)&_binary_cbfwv_start;
    Size = (UINTN)&_binary_cbfwv_end - (UINTN)&_binary_cbfwv_start;
